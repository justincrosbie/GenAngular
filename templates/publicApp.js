window.app = angular.module('${app.name}', ['ngCookies', 'ngResource', 'ui.bootstrap', 'ui.select2', 'ngTable', '$strap.directives', 'ngRoute', 'ngAnimate', 
...
${--repeat1:model:model:											'ngff.controllers.${model.name}s'${end-comma} 
--1}
										]);
window.angular.module('ngff.services',
										[
											'ngff.services.global',
${--repeat2:model:model:											'ngff.services.${model.name}s'${end-comma} 
--2}
										]);
